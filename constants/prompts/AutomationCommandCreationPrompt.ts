export enum AutomationCommandCreationPrompt {
    TEMPLATE = `  
Combine the original workflow request with user-provided answers to create a **valid,   automation command**. Follow these rules:
